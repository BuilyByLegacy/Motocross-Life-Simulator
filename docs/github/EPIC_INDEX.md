...
| [19_living_world_reputation_legacy_backlog_issues.md](issues/19_living_world_reputation_legacy_backlog_issues.md) | Living World, Reputation, and Legacy Backlog | Drafts design/documentation issues for Living Motocross World, Dynamic AI Careers, Group Reputation, Dealer Network, Bike Lifecycle, Hall of Fame and Legacy Archive, Rider Personality and Identity, Race Weekend Decision Events, and DD-0039 through DD-0042. | Dynamic Community Engine; Career Outcomes System; Personality Identity Engine; Bike Ownership System; Garage Shop System; Marketplace; Memory Engine; Documentary Legacy Recap Engine; Competition Engine; Opportunity Engine |
| [20_home_region_geographic_world_issues.md](issues/20_home_region_geographic_world_issues.md) | Home Region & Geographic World Simulation | Drafts design/documentation issues for home region selection, geographic world simulation, regional racing calendar, regional tracks, travel distance/cost, regional weather, regional competition strength, regional reputation, local dealer network, hometown pride, regional riding style development, v1.0 geographic scope, and DD-0043 through DD-0045. | Calendar & Time Engine; Track Venue System; Dynamic Community Engine; Career Outcomes System; Marketplace; Memory Engine; Training Practice Engine; Release Readiness |
| [30_trip_at_a_glance_daily_planning_issues.md](issues/30_trip_at_a_glance_daily_planning_issues.md) | WonderLane Trip at a Glance & Daily Planning Upgrade | Drafts product, design, engineering, architecture, and testing issues for Trip at a Glance Upgrade, Daily Planning Upgrade, Schedule Guidance, Daily Readiness, Daily Planning Rules, Trip Timeline, and Morning/Afternoon/Evening Blocks. | Command Center; Trip Overview; Schedule; Daily Planning; Readiness; Rules; Timeline; Mobile |


## Master Roadmap

Use [`MASTER_ROADMAP.md`](../../MASTER_ROADMAP.md) as the top-level planning reference for product vision, App Store v1.0 scope, launch non-goals, release readiness, and version-horizon categorization. Epics should remain aligned with the roadmap while preserving future-facing plans that are outside the v1.0 launch cutline.
